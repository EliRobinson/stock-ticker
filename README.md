...
| Hooks as CI                                | Husky pre-commit/pre-push hooks are the actual quality gate; GitHub Actions does not run on push or PR                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | [AGENTS.md § Git Hooks](AGENTS.md#git-hooks-husky)                                                                                                                                                        |
