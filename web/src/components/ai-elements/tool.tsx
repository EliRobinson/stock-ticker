...
const statusIcons: Record<ToolPart['state'], ReactNode> = {
  'approval-requested': <ClockIcon className='text-amber size-4' />,
  'approval-responded': <CheckCircleIcon className='text-brand size-4' />,
  'input-available': <ClockIcon className='size-4 animate-pulse' />,
  'input-streaming': <CircleIcon className='size-4' />,
  'output-available': <CheckCircleIcon className='text-up size-4' />,
  'output-denied': <XCircleIcon className='text-amber size-4' />,
  'output-error': <XCircleIcon className='text-down size-4' />
}
