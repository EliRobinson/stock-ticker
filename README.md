...
**Open follow-ups:** [#38](https://github.com/EliRobinson/stock-ticker/issues/38) (malformed Wikipedia tickers, the slow first backfill, tests writing to the dev DB), [#29](https://github.com/EliRobinson/stock-ticker/issues/29) (ingest helpers; drop `_paged` — already landed with #26). See all [open issues](https://github.com/EliRobinson/stock-ticker/issues).
