...
**Open follow-ups:** [#38](https://github.com/EliRobinson/stock-ticker/issues/38) (malformed Wikipedia tickers, the slow first backfill, tests writing to the shared compose DB), [#26](https://github.com/EliRobinson/stock-ticker/issues/26) (Alpaca ingest cleanups: `_paged`, commit ownership, `bars_daily` → `queue_refetch`, bars_backfill / corporate_actions watermark helpers). [#29](https://github.com/EliRobinson/stock-ticker/issues/29) landed the non-overlapping half (watermarks/refetch/CIK/EDGAR test DRY). See all [open issues](https://github.com/EliRobinson/stock-ticker/issues).
