...
**Open follow-ups:** [#38](https://github.com/EliRobinson/stock-ticker/issues/38) (malformed Wikipedia tickers, the slow first backfill, tests writing to the shared compose DB). [#26](https://github.com/EliRobinson/stock-ticker/issues/26) (Alpaca cleanups) and [#29](https://github.com/EliRobinson/stock-ticker/issues/29) (shared ingest helpers: `queue_refetch`, `normalize_cik`, EDGAR/`Scenario` test DRY) are merged. See all [open issues](https://github.com/EliRobinson/stock-ticker/issues).
